...
/*
- O nome das classes inicia com letra maíuscula;
...
- Atributos são nomeados em letras minúsculas, sem espaço,
sem caractere especiais, sem acentuação.
*/

//Métodos
/*
- Podemos entender o método como a ação que é realizada por um objeto da classe;
